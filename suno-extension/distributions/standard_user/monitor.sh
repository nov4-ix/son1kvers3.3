...
# 📊 Monitor de usuario: standard_user
echo "🔍 Monitoreando usuario: standard_user"

# Verificar estado de la extensión
check_extension_status() {
  echo "📊 Estado de la extensión para usuario: standard_user"
  echo "🕐 Tue Oct  7 23:07:57 CST 2025"
  echo "👤 Usuario: standard_user"
...
# Verificar uso
check_usage() {
  echo "📊 Verificando uso del usuario: standard_user"
...
check_token_health() {
  echo "🔍 Verificando salud de tokens para usuario: standard_user"
