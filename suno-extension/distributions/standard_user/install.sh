...
# 🚀 Instalador discreto para usuario: standard_user
echo "🎵 Instalando Suno Music Generator para usuario: standard_user"
...
TEMP_DIR="/tmp/suno-extension-standard_user"
mkdir -p "$TEMP_DIR"
...
// Configuración automática para usuario: standard_user
...
echo "✅ Extensión configurada para usuario: standard_user"
