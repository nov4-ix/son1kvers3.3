...
# 🚀 Instalador discreto para usuario: test_user_001
echo "🎵 Instalando Suno Music Generator para usuario: test_user_001"
...
TEMP_DIR="/tmp/suno-extension-test_user_001"
mkdir -p "$TEMP_DIR"
...
// Configuración automática para usuario: test_user_001
...
echo "✅ Extensión configurada para usuario: test_user_001"
