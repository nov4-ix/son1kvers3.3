...
# 📊 Monitor de usuario: demo_user
echo "🔍 Monitoreando usuario: demo_user"

# Verificar estado de la extensión
check_extension_status() {
  echo "📊 Estado de la extensión para usuario: demo_user"
  echo "🕐 Tue Oct  7 22:38:44 CST 2025"
  echo "👤 Usuario: demo_user"
...
# Verificar uso
check_usage() {
  echo "📊 Verificando uso del usuario: demo_user"
...
check_token_health() {
  echo "🔍 Verificando salud de tokens para usuario: demo_user"
