...
# 🚀 Instalador discreto para usuario: demo_user
echo "🎵 Instalando Suno Music Generator para usuario: demo_user"
...
TEMP_DIR="/tmp/suno-extension-demo_user"
mkdir -p "$TEMP_DIR"
...
// Configuración automática para usuario: demo_user
...
echo "✅ Extensión configurada para usuario: demo_user"
