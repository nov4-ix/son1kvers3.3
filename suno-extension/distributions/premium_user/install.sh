...
# 🚀 Instalador discreto para usuario: premium_user
echo "🎵 Instalando Suno Music Generator para usuario: premium_user"
...
TEMP_DIR="/tmp/suno-extension-premium_user"
mkdir -p "$TEMP_DIR"
...
// Configuración automática para usuario: premium_user
...
echo "✅ Extensión configurada para usuario: premium_user"
