...
# 📊 Monitor de usuario: test_user_003
echo "🔍 Monitoreando usuario: test_user_003"

# Verificar estado de la extensión
check_extension_status() {
  echo "📊 Estado de la extensión para usuario: test_user_003"
  echo "🕐 Tue Oct  7 23:08:16 CST 2025"
  echo "👤 Usuario: test_user_003"
  echo "🎵 Token: token_003"
...
# Verificar uso
check_usage() {
  echo "📊 Verificando uso del usuario: test_user_003"
...
check_token_health() {
  echo "🔍 Verificando salud de tokens para usuario: test_user_003"
