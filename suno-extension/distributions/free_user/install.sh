...
# 🚀 Instalador discreto para usuario: free_user
echo "🎵 Instalando Suno Music Generator para usuario: free_user"
...
TEMP_DIR="/tmp/suno-extension-free_user"
mkdir -p "$TEMP_DIR"
...
// Configuración automática para usuario: free_user
...
echo "✅ Extensión configurada para usuario: free_user"
