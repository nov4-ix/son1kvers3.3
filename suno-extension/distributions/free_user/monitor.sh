...
# 📊 Monitor de usuario: free_user
echo "🔍 Monitoreando usuario: free_user"

# Verificar estado de la extensión
check_extension_status() {
  echo "📊 Estado de la extensión para usuario: free_user"
  echo "🕐 Tue Oct  7 23:07:16 CST 2025"
  echo "👤 Usuario: free_user"
...
# Verificar uso
check_usage() {
  echo "📊 Verificando uso del usuario: free_user"
...
check_token_health() {
  echo "🔍 Verificando salud de tokens para usuario: free_user"
