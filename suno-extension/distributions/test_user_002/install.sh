...
# 🚀 Instalador discreto para usuario: test_user_002
echo "🎵 Instalando Suno Music Generator para usuario: test_user_002"
...
TEMP_DIR="/tmp/suno-extension-test_user_002"
mkdir -p "$TEMP_DIR"
...
// Configuración automática para usuario: test_user_002
...
echo "✅ Extensión configurada para usuario: test_user_002"
