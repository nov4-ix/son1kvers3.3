// Configuración SSV-BETA: pro.tester8@son1kvers3.com
const USER_CONFIG = {
  userId: 'pro_tester8',
  email: 'pro.tester8@son1kvers3.com',
  password: 'Premium!123',
  tier: 'pro',
  token: 'PRO_TOKEN_PRO_TESTER8',
  dailyLimit: 50,
  monthlyLimit: 1500,
  concurrentLimit: 3,
  rateLimit: 30,
...
const USER_TOKENS = {
  primary: 'PRO_TOKEN_PRO_TESTER8',
  backup: 'PRO_TOKEN_PRO_TESTER8_BACKUP'
};
